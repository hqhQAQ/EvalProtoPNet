...
def evaluate_consistency(ppnet, args, half_size=36, part_thresh=0.8):
    ...
    class_proto_effect, class_mean_part = [], []
    for test_image_label in tqdm(range(num_classes)):
        ...
        all_mean_part, all_proto_effect = [], []
    ...
    # print('All Proto Score: {}'.format(class_proto_effect_score))

    return class_proto_effect_score * 100